...
function draw() {
  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      path.velocityY = path.velocityY + 0.25
      cashG.setVelocityYEach = cashG.setVelocityYEach + 0.5
      diamondsG.setVelocityYEach = diamondsG.setVelocityYEach + 0.5
      jewelryG.setVelocityYEach = jewelryG.setVelocityYEach + 0.5
      swordGroup.setVelocityYEach = swordGroup.setVelocityYEach + 0.5
      carG.setVelocityYEach = carG.setVelocityYEach + 0.5
